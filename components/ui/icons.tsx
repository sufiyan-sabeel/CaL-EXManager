...
type IconName =
  ...
  | "performance" | "apps" | "notes" | "notifications" | "privacy" | "insights" | "lock" | "activity" | "shield" | "zap" | "layers" | "smartphone" | "battery" | "hardDrive" | "cpu" | "more" | "chevronRight" | "chevronDown" | "x" | "check" | "alert" | "info";
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  performance: <><path d="M3 3v18h18" /><path d="M7 12l2-2 2 2 4-5 3 3" /><circle cx="18" cy="7" r="1.5" fill="currentColor" stroke="none" /></>,
  apps: <><rect x="3" y="3" width="7" height="7" rx="1.5" /><rect x="14" y="3" width="7" height="7" rx="1.5" /><rect x="3" y="14" width="7" height="7" rx="1.5" /><path d="M14 14h7v7h-7z" /><path d="M16 17h3M17.5 15.5v3" /></>,
  notes: <><path d="M14 2H7a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /><path d="M9 13h6M9 17h6" /></>,
  notifications: <><path d="M15 17h5l-1.5-1.5a6 6 0 0 1-3.5-5.5V9a3 3 0 0 0-6 0v1a6 6 0 0 1-3.5 5.5L4 17h5" /><path d="M9 17a3 3 0 0 0 6 0" /></>,
  privacy: <><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path d="M9 12l2 2 4-4" /></>,
  insights: <><path d="M3 3v18h18" /><path d="M7 16l3-3 4 2 3-7" /><circle cx="17" cy="9" r="1" fill="currentColor" stroke="none" /></>,
  lock: <><rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /><circle cx="12" cy="16" r="1" fill="currentColor" /></>,
  activity: <><path d="M22 12h-4l-3 9L9 3l-3 9H2" /></>,
  shield: <><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></>,
  zap: <><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" /></>,
  layers: <><path d="M12 2L2 7l10 5 10-5-10-5z" /><path d="M2 17l10 5 10-5" /><path d="M2 12l10 5 10-5" /></>,
  smartphone: <><rect x="5" y="2" width="14" height="20" rx="2" /><path d="M12 18h.01" /></>,
  battery: <><rect x="2" y="7" width="16" height="10" rx="2" /><path d="M20 10v4" /><path d="M6 12h4" /></>,
  hardDrive: <><rect x="3" y="3" width="18" height="10" rx="2" /><rect x="3" y="13" width="18" height="8" rx="2" /><circle cx="8" cy="8" r="1" fill="currentColor" /><circle cx="8" cy="17" r="1" fill="currentColor" /></>,
  cpu: <><rect x="4" y="4" width="16" height="16" rx="2" /><rect x="9" y="9" width="6" height="6" /><path d="M9 1v3M14 1v3M9 20v3M14 20v3M20 9h3M20 14h3M1 9h3M1 14h3" /></>,
  ...
  alert: <><path d="M12 9v4" /><path d="M12 17h.01" /><path d="M10.3 3.5l-8 14A1 1 0 0 0 3.1 19h16a1 1 0 0 0 .8-1.5l-8-14a1 1 0 0 0-1.6 0z" /></>,
